...
class AdminIndexDashboard(Dashboard):
    ...
    def init_with_context(self, context):
        ...
        self.children.append(modules.LinkList(
            ...
            children=[
                {
                    'title': _('Admin Task A'),
                    'url': reverse('app_name:run-task', kwargs={'task': 'task-a'}),
                },
                {
                    'title': _('Admin Task B'),
                    'url': reverse('app_name:run-task', kwargs={'task': 'task-b'}),
                },
            ]
        ))
...
class AdminAppIndexDashboard(AppIndexDashboard):
    ...
    def init_with_context(self, context):
        ...
        """
        return super(AdminAppIndexDashboard, self).init_with_context(context)
